<script lang="ts">
    ...
    async function disable2FA() {
        ...
        const apiRes = await invokeAPI<unknown>("signed/2fa/disable", {
            recoveryKey,
        });
        if (!apiRes)
            return setError(
    ...
    <div class="flex flex-col gap-4 py-4 text-white p-8">
        ...
        <div class="flex flex-col gap-2">
            ...
            <p class="text-gray-200">
                Please note that disabling 2FA increases the likelyhood of your
                account being accessed by an unknown individual or bot.
            </p>
            <p class="text-gray-200">
                You will need your recovery key in order to disable this
                feature.
            </p>
        </div>
        <div class="flex flex-col gap-2">
