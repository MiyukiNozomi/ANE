  ...
  async function onAuthorize() {
    ...
    switch (currentStep) {
      case Steps.ASK_AUTHORIZATION: {
        ...
        if (res?.translatedError) return (errorMessage = res.translatedError);
        ...
        {#if progressAPI && !progressAPI.isActive()}
          {#if currentStep == Steps.MISSING_OR_EXPIRED}
            <div transition:slide class="flex flex-col gap-2">
              ...
              <p>
                You have attempted to authorize a Invalid or non-existant
                session request.
              </p>
              <p>
                Therefore, there's no possible way to proceed besides
          ...
          {:else if currentStep == Steps.ASK_AUTHORIZATION}
            <div transition:slide class="flex flex-col gap-2">
              ...
              <p>
                The application '{data.reqInfo?.realm}' is requesting your
                authorization.
              </p>
              <p>
                It will be able to view your profile information, but won't be
            ...
            <div transition:slide class="flex flex-col gap-2">
              ...
              <p>
                ...
                If you want to remove it do it from your <a
                  ...
                  href="/home/settings/sessions">account settings</a
                >.
              </p>
            </div>
          {:else if currentStep == Steps.ALREADY_AUTHORIZED}
            <div transition:slide class="flex flex-col gap-2">
              ...
              <p>
                You appear to have already given authorization to this request.
              </p>
              <p>
                If you believe this to be a mistake, manage your sessions and
                authorizations <a
                  class="text-red-500 underline"
